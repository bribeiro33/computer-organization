func    lw          0        6        one       r6 = temp value, 1 | func to base = storing ret.add, n, r to stack
        ...
        add         6        5        5         stack ptr++
base    noop                                    base to recur = base case
        beq         2        0        r1        r == 0 --> return 1
        beq         2        1        r1        r == n --> return 1
recur   noop                                    recur to next = set up recur (else statement in c)
        beq         2        6        rn        r == 1 --> return n
...
recur2  noop
        ...
        sw          5        3        Stack     store return val on stack
        add         6        5        5         stack ptr++
sum     noop                                    add two return vals together
        lw          0        6        neg1      r6 = -1
        add         6        5        5         stack ptr--
